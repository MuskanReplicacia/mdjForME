...
public class EnglishNoun {
	...
	public static void main(String[] args) {
		System.out.println( isPlural("orderItems"));
		System.out.println( pluralOf("orderItems"));
	}
    /**
     ...
     */
    public static String pluralOf(String word) {  //word = word.toLowerCase();
     ...
     */
    public static String singularOf(String word) {  //word = word.toLowerCase();
